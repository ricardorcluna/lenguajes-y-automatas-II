 ...
 *: 12/SEP/2017 FGil               -Se corrigio error que impedia reconocer el token ..
 *:                                 simplemente se intercambiaron de posicion los 
 *:                                 automatas 14 y 15 correspondientes a CarEsp y Punto.
 *: 09/Sep/2019 FGil               - Preparar codigo para usarlo en el sem AD/2019
 *:                                 Las literales van entre comillas dobles.
 *:                                 Se modifico la case para que reconociera bien
 *:                                 los opasig y el oprel.
 *:-----------------------------------------------------------------------------
 */
