 ...
 *:=============================================================================
 *: 28/Ago/2016 F.Gil               Adaptacion para abrir/guardar programas .pas
 *:-----------------------------------------------------------------------------
 */
...
public class CompiladorFrame extends javax.swing.JFrame implements ErroresListener {
    ...
    public static final String LENGUAJE     = "BasicTec";
    public static final String EXTENSION    = "bas";
    public static final String TIPO_ARCHIVO = "Basic";
    public static final String TXT_TIPO_ARCH= "Archivos de programa " + LENGUAJE + " (*." + EXTENSION + ")";
    ...
    private final String nombreApp = "Compilador de Lenguaje " + LENGUAJE;
...
//----------------------------------------------------------------------------
    ...
    private void initComponents() {
        ...
        setTitle("Compilador de Lenguaje");
    ...
    private void jmniArchivoGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jmniArchivoGuardarActionPerformed
        ...
        if (band == false) {
            ...
            if (jfc.showSaveDialog(this) == JFileChooser.APPROVE_OPTION) {
                ...
                try {
                    fw = new FileWriter(archivo + "." + EXTENSION, false);
